...
import { ExperienceHeader } from './ExperienceTimeline.jsx';
...
function EntryContent({ entry }) {
  ...
  return <>
          {
            // Roles show their place and part-time status in the shared header instead.
            !entry.companyId && <p className="journey-location">
              {
              ...
              </a>
              {
                selected.companyId
                  ? <div className="experience-detail">
                      <CompanyLogo companyId={selected.companyId} />
                      <ExperienceHeader entry={selected} as="h3" />
                    </div>
                  : <>
                      <h3>{t(selected.title)}</h3>
                      <p className="journey-organization">
                        {selected.country && <CountryFlag code={selected.country} />}{selected.organization}
                      </p>
                ...
                <li key={entry.id}>
                  <details>
                    <summary>
                      ...
                      <span className="journey-organization">
                        {entry.country && <CountryFlag code={entry.country} />}{entry.organization}
                      </span>
