...
export const profilePhotos = [
  { id: 'front', src: front, alt: 'Jorge Hernández facing the camera against a white background.', position: '50% 50%', width: 1254, height: 1254 },
  { id: 'relaxed', src: relaxed, alt: 'Jorge Hernández smiling with one hand behind his head.', position: '50% 50%', width: 1254, height: 1254 },
  { id: 'playful', src: playful, alt: 'Jorge Hernández pointing toward the camera.', position: '50% 50%', width: 1254, height: 1254 },
];
